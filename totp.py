...
# Prepare the body
body = {
  "github_url": gistURL,  # Use your actual Gist URL here
  "contact_email": userid,
  "solution_language": "python"
}

# Send the POST request
response = requests.post("https://api.challenge.hennge.com/challenges/backend-recursion/004", headers=headers, json=body)
